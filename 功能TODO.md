...
4. 每日日程的日程安排界面，右侧的日期是写死的10月24日 星期三，这个应该和日历日期一致（2026-04-04T12:20:09）
5. 生活记录页面，灵感与启发和感悟与思考的读数据读错了，两个相反了。（2026-04-04T12:21:41）
6. 生活记录页面的文字记录部分的六个卡片标题我想全部改成中文，请告诉我在哪里改？（2026-04-04T12:22:44）
...
22. 我希望大模型在回答我的问题时，尤其是安排日程和时间表两个问题上，安排日程的部分只说当日目标，要细化一些，类似于读书读到多少页，程序写多少行，写到什么效果。时间表上，事实上我只希望大模型填空，填写我在这一天没有预制好的时间段里面的任务，每30分钟一个，而不是重写我整个日程表。我不知道这个效果是修改system prompt比较好还是要写什么工具？（2026-03-09T11:10:32）
23. 接入Xai的api，在ai导师部分下拉框加入Xai选项。我会在.env配置好api，我会安装好基础框架。（2026-03-09T11:21:17）
24. 每日日程安排，无论是哪一个表格，我都希望它能够批量进行填写。像 Excel 那样的：
直接多选，然后写一个直接进去或者连续复制。（2026-04-04T19:32:49）
25. 还是日程安排这一部分，我希望当我的预期和实际不一样的时候，这一格能变成别的颜色。如果一致的话就没有颜色，如果不一致就是红色。（2026-04-04T19:34:38）
